...
public class AnalyticsController {
    ...
    @FXML
    private TableColumn<AnalyticsRecord, Integer> idColumn;
    @FXML
    private TableColumn<AnalyticsRecord, String> algorithmColumn;
    @FXML
    private TableColumn<AnalyticsRecord, String> resolutionColumn;
    @FXML
    private TableColumn<AnalyticsRecord, Double> sizeColumn;
    @FXML
    private TableColumn<AnalyticsRecord, Double> ratioColumn;
    @FXML
    private TableColumn<AnalyticsRecord, String> timestampColumn;

    @FXML
    private PieChart algorithmUsageChart;
    @FXML
